...
● Open WhatsApp Web (https://web.whatsapp.com) and place the mouse cursor on the "Search" box, now don't move the mouse cursor from there and open the IDLE. Don't use the mouse, use Alt+Tab to open IDLE.
